        ...
        {whyChoose.map((item) => {
          ...
          return (
            <div key={item.title} className="group flex gap-4">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-brand-red/10 text-brand-red ring-1 ring-brand-red/10 transition-colors duration-300 group-hover:bg-brand-red group-hover:text-white sm:h-14 sm:w-14">
